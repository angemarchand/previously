                ...
                <div className="collapse navbar-collapse linkNav" id="navbarSupportedContent">
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                      ...
                      <Link to="/" className="nav-link active linkNav" aria-current="page" >Home </Link>
                    </li>
                    <li className="nav-item">
                      {/* <a className="nav-link" href="#">Link</a> */}
                      <Link to="#" className="nav-link linkNav"> Link </Link>
                    </li>
                  ...
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item dropdown">
                          ...
                          <Link to="#" className="nav-link dropdown-toggle linkNav" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown </Link>
