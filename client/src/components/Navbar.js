    ...
    <div>
        <nav className="navbar navbar-expand-lg navbar-light mb-5 bgNav">
            <div className="container-fluid">
                ...
                <Link to="#" className="navbar-brand">DARKSERIES </Link>
                ...
                <div className="collapse navbar-collapse linkNav" id="navbarSupportedContent">
                  ...
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item dropdown">
                          ...
                          <Link to="#" className="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown </Link>
